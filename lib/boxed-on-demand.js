...
function BoxedOnDemand(getState, saveState, options) {
    ...
    this.saveBoxedProp = wrapProps ? this.context.reWrapMagicProp(saveBoxedProp) : saveBoxedProp;
    this.cancelBoxedProp = wrapProps ? this.context.reWrapMagicProp(cancelBoxedProp) : cancelBoxedProp;

...
Box.prototype.getBoxedProp = function (prop) {
    ...
    //     const defaultTransform = this.getTransforms[BOXED_ARRAY_END];
    //
...
Box.prototype.set = function (prop, value, boxed) {
    ...
    if (isArrayEnd) {
        if (prop === BOXED_ARRAY_END) prop = util.arrayEndIndex(this.value);
...
Box.prototype.delete = function (prop) {
    ...
    if (isObject(this.value) && this.value.hasOwnProperty(prop)) {
        ...
        const transform = prop !== BOXED_ARRAY_END && this.setTransforms[prop];
        const defaultTransform = this.setTransforms[BOXED_ARRAY_END];
...
Box.prototype.setValueOf = function (value) {
    ...
    if (isObject(this.setTransforms)) {
        value = applyTransforms(value, this.setTransforms, true, true);
    }

...
function getWithBoxedOut(value) {
    const newInstance = isObject(value)  ? isArray(value) ? boxOut([]) : boxOut({}) : UNDEFINED;  // pure objects for proxy use
    return newInstance;
}
...
Box.prototype.set = function (prop, value, boxed) {
    ...
    if (this.extraValues) {
        ...
        util.eachKey.call(this.extraValues, (value, key) => {
        ...
        if (this.value === UNDEFINED) this.setValueOf(value);
            ...
            if (levels > 0) {
                if (isArray(value)) {
                    ...
                    eachKey.call(value, (keyValue, key) => {
...
Box.prototype.valueObjectBoxedOut = function (callback) {
    if (util.isObject(this.value) && !util.isArray(this.value)) {
        // this is just the boxed out value 
    } else {
